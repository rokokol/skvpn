...
- **the completion command lists are hand-written on purpose** and the suite checks them against `skvpn.COMMANDS` — a command added to the CLI fails the tests until it lands in both completion files
