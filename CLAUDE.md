...
- **process rules need two capabilities on the unit**, or every split entry is a silent no-op — `PITFALLS.md` has the mechanism and the three places that must keep them
